...
*/
--1부터 누적하기. 누적결과가 100을 넘어가면 그만 누적하고 출력하기
...
--무한루프
    WHILE TRUE LOOP
        ...
        SELECT MOD(N,3) INTO MODULAR --3으로 나눈 나머지는 MODULAR 변수에 저장
            FROM DUAL;
        IF MODULAR =0 THEN 
            CONTINUE; --WHILE TRUE LOOP 문의 첫 실행문으로 되돌아가서 실행하시오.// 무언가를 제외하고 싶을때 사용하는게 CONTINUE
