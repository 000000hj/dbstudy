...
-- 1) ANSI
SELECT E.EMPLOYEE_ID,E.HIRE_DATE,E.FIRST_NAME,
        M.FIRST_NAME ,M.EMPLOYEE_ID,M.HIRE_DATE
...
SELECT ME.EMPLOYEE_ID, ME.FIRST_NAME,ME.SALARY AS 내급여
    ,E.FIRST_NAME,E.SALARY AS 사원급여
    ,ME.DEPARTMENT_ID,E.DEPARTMENT_ID
    FROM EMPLOYEES ME INNER JOIN EMPLOYEES E
    ON ME.DEPARTMENT_ID= E.DEPARTMENT_ID
    WHERE ME.SALARY<E.SALARY
