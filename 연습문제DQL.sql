...
SELECT SUBSTR(SALARY,LENGTH(SALARY)-4,2) || ','|| SUBSTR(SALARY,LENGTH(SALARY)-(LENGTH(SALARY)-3))
FROM EMPLOYEES
...
SELECT DECODE(SUBSTR(PHONE_NUMBER,0,3),'011','MOBILE')AS REGION
       ,DECODE(SUBSTR(PHONE_NUMBER,0,3),'515','EAST')AS REGION
       ,DECODE(SUBSTR(PHONE_NUMBER,0,3),'590','WEST')AS REGION
       ,DECODE(SUBSTR(PHONE_NUMBER,0,3),'603','SOUTH')AS REGION
       ,DECODE(SUBSTR(PHONE_NUMBER,0,3),'650','NORTH')AS REGION
FROM EMPLOYEES ;
